...
public class SocketCliente implements Closeable {
    ...
    private final ObjectInputStream in; // Objeto de leitura das mensagens do servidor/outros clientes
    private final ObjectOutputStream out; // Objeto de escrita das mensagens do próprio cliente
    ...
    // Envia o objeto Mensagem até outro dispositivo conectado
    ...
    // Recebe o objeto Mensagem a partir de outro dispositivo conectado
    ...
    // Função get que retorna o login do cliente
    public String getLogin() {
        return this.login;
    }

    // Função set que define o login do cliente
    public void setLogin(String login) {
        this.login = login;
    }

    // Função get que retorna o id do bandeco conectado
    public String getIdBandeco() {
        return this.idBandeco;
    }

    // Função set que define o id do bandeco conectado
